...
- **(A4) Transportability** : 
  - for $\phi,$ $Y(c_1),Y(c_2)\perp\!\!\perp S\mid V$; where $V=\text{country};$ (standard-of-care is typically defined at the national level, often guided by, e.g., WHO, and implemented through country-specific clinical guidelines.)
