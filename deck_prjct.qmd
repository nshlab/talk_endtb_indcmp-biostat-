...
::: {style="font-size: 85%;"}
Instead of directly comparing 6BPaLM vs. 9-month regimens, we break the problem into:

1. **The difference in treatment effects**  ($\theta$):
   how much better is 6BPaLM vs. *its* standard care, compared to how much better a 9-month regimen is vs. *its* standard care?

2. **The difference in standard care**  ($\phi$):
