---
title: "Cross-Trial Causal Comparison of Treatment Regimens Without a Common Comparator: A Case Study of MDR/RR-TB and HIV"
format:
  clean-revealjs:
...
::: {style="font-size: 85%; background-color: #f0f8ff; padding: 10px; border-left: 5px solid #4682b4;"}
Theroem (informal) The one-step estimator $\hat{\psi}_{\text{1step}}(a,b)$ satisfies: (1) Consistency.  $\hat{\psi}_{\text{1step}}(a,b) \xrightarrow{\mathbb{P}_{\Omega}} \psi(a, b).$ (2) Asymptotic linearity and normality: we have the expansion
